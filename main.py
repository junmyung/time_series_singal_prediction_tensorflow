...
def main():
  ...
  flags.DEFINE_string("save_path", "./checkpoints/sp500_lstm",
  ...
  flags.DEFINE_integer("output_length", 1, "")
  ...
  flags.DEFINE_integer("epoch_size", 10000, "")
  ...
  flags.DEFINE_boolean("save_plot", False, '')
  flags.DEFINE_boolean("eval_only", True, '')
  FLAGS = flags.FLAGS

  data_loader = Dataset_Loader(data_name='stock', stock_name=None)
